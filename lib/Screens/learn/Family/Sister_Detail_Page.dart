...
class Sister_Detail_Page extends StatefulWidget {
  const Sister_Detail_Page({Key? key}) : super(key: key);

  @override
  _Sister_Detail_PageState createState() => _Sister_Detail_PageState();
}

class _Sister_Detail_PageState extends State<Sister_Detail_Page> {
  final FlickManager flickmanager = FlickManager(
      videoPlayerController: VideoPlayerController.asset("assets/sister.mp4"));
