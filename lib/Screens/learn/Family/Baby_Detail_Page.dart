...
class Baby_Detail_Page extends StatefulWidget {
  const Baby_Detail_Page({Key? key}) : super(key: key);

  @override
  _Baby_Detail_PageState createState() => _Baby_Detail_PageState();
}

class _Baby_Detail_PageState extends State<Baby_Detail_Page> {
  final FlickManager flickmanager = FlickManager(
      videoPlayerController: VideoPlayerController.asset("assets/baby.mp4"));
