...
class Mother_Detail_Page extends StatefulWidget {
  const Mother_Detail_Page({Key? key}) : super(key: key);

  @override
  _Mother_Detail_PageState createState() => _Mother_Detail_PageState();
}

class _Mother_Detail_PageState extends State<Mother_Detail_Page> {
