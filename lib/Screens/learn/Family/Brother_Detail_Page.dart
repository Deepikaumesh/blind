...
class Brother_Detail_Page extends StatefulWidget {
  const Brother_Detail_Page({Key? key}) : super(key: key);

  @override
  _Brother_Detail_PageState createState() => _Brother_Detail_PageState();
}

class _Brother_Detail_PageState extends State<Brother_Detail_Page> {
